...
public class Main extends Application {
	...
	public static ObservableList<Fournisseur> listFournisseurs = FXCollections.observableArrayList();
...
//			Scene scene = new Scene(root,380,500);
			...
			BorderPane root = (BorderPane)FXMLLoader.load(getClass().getResource("AjoutFournisseur.fxml"));
			Scene scene = new Scene(root,380,500);
